...
const CoinDetailsPage = () => {
	...
	useEffect(() => {
		const fetchCoin = async () => {
			try {
				...
				if (!data.id) {
					throw new Error('Invalid response: missing coin ID');
				}
	...
	return (
		<div className='coin-details-container'>
			...
			{!loading && !error && coin && coin.image && coin.market_data && (
				<>
					<img
					...
					<div className='coin-details-info'>
						...
						<h4>
							Market Cap: {coin.market_data.market_cap.eur.toLocaleString()} €
						</h4>
						<h4>
							24h High: {coin.market_data.high_24h.eur.toLocaleString()} €
						</h4>{' '}
